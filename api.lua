 ...
 if redis:get(hash) then
    ...
    return false
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[🔖Send Your Msg🔖](https://telegram.me/Ultrakingbot)',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[✔️Send Your Problem✔️](https://telegram.me/ultrakingbot)',keyboard)
            end
							------------------------------------------------------------------------
